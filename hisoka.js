...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync('./lib/hisoka.jpg'), surface: 200, message: `W r a n G a m t e n g ㍍`, orderTitle: 'Please Follow Tiktok @hengkerwbu9', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
https://github.com/DikaArdnt/Hisoka-Morou
 Recode By : WranzzZ:
https://vt.tiktok.com/ZSdqJCGb5/`
                let button = [{
                                urlButton: {
                                    displayText: 'Tiktok Creator',
                                    url: 'https://vt.tiktok.com/ZSdqJCGb5/'
                                }
                            }]
                hisoka.send5ButImg(m.chat, anu, hisoka.user.name, global.thumb, button)
            }
            break
            case 'anjir': {
                m.reply('anjir bjir lu kira banjir,,Blog')
            }
            break
            case 'p': {
                m.reply('pape pape ini bot kntod')
            }
            break
